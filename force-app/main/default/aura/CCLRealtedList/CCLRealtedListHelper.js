({
    fetchData: function (cmp, event, helper) {
        ...
        action.setCallback(this, function (response) {
            ...
            if (state === "SUCCESS") {
                ...
                cmp.set('v.numberOfRecordsForTitle', records.length)
                ...
                cmp.set('v.numberOfRecords', records.length)
    ...
    viewIndividualRecords: function (cmp, row) {
        cmp.set('v.parentId', row.Id);
        cmp.set('v.individualModalPopup', true);
        debugger;
    },
    removeRecord: function (cmp, row) {
        ...
        $A.createComponents([
            ["c:deleteRecordContent", {
                sobjectLabel: sobjectLabel
            }],
            ["c:deleteRecordFooter", {
                record: row,
                sobjectLabel: sobjectLabel
            }]
        ],
